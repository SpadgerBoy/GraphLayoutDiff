...
class GATConv_1(MessagePassing):
    ...
    def __init__(self, in_channels: Union[int, Tuple[int, int]],
        ...
        super(GATConv_1, self).__init__(node_dim=0, **kwargs)
    ...
    def message(self, x_j: Tensor, x_i: Tensor, edge_attr: OptTensor,
        ...
        alpha = (edge_attr * self.att).sum(dim=-1)
...
class GATEncoder_1(torch.nn.Module):
    ...
    def __init__(self, hidden_dim, num_convs=3, activation='relu', short_cut=True, concat_hidden=False, node_channels=5):
        ...
        for i in range(self.num_convs):
            self.convs.append(GATConv_1(in_channels=self.hidden_dim, out_channels=self.hidden_dim, edge_dim=self.hidden_dim))
