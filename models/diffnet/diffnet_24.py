...
class EDM_Block(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.encoder_local = GINEncoder(
            ...
            node_channels = config.laplacian_eigenvector + config.hidden_dim,
...
class GraphDiffusionNetwork(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.model_local = nn.ModuleList([self.convs, self.temb, self.temb_proj])
    ...
    def forward(self, node_emb, node_type, node_degree, pos, edge_index, edge_type, batch, time_step,
        ...
        temb_node = temb.index_select(0, batch)  # (E , dim)
