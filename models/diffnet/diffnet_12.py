...
from ..encoder import SchNetEncoder, GINEncoder, get_edge_encoder, GINEncoder_Global, get_node_encoder, get_degree_encoder, get_edge_encoder_2
...
class EDM_Block(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.edge_encoder_local = get_edge_encoder_2(config)
