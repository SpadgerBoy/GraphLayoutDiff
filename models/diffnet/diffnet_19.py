...
from ..encoder import SchNetEncoder, GINEncoder, get_edge_encoder, GINEncoder_Global, get_node_encoder, get_degree_encoder, GATEncoder_1
...
class EDM_Block(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.encoder_local = GATEncoder_1(
