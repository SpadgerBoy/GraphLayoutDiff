...
for i, file_name in enumerate(folder_names):
    ...
    all_data_list.append(layout_compute(G, "circular_layout", file_name))
...
train_save_path = '../data/rome_circular/train_layout.pkl'
with open(train_save_path, 'wb') as file:
    pickle.dump(train_data_list, file)    

val_save_path = '../data/rome_circular/val_layout.pkl'
with open(val_save_path, 'wb') as file:
    pickle.dump(val_data_list, file)    

test_save_path = '../data/rome_circular/test_layout.pkl'
